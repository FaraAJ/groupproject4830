		...
		// TODO Auto-generated method stub
	      ...
	      try {
	    	  ...
	    	  while(rs.next()) {
	    		  ...
	    		  response.getWriter().append("username: "+rs.getString("name")+"<br>");
	    		  response.getWriter().append("password: "+rs.getString("password")+"<br>");
	    		  response.getWriter().append("phone num: "+rs.getString("phone")+"<br>");
	    		  if (Integer.parseInt(rs.getString("is_admin")) == 1) {
	    			  response.getWriter().append("is an admin<br>");
	    		  }
